...
// --- Mock Data ---
const DOCTORS = [
  { id: 1, name: 'د. أحمد محمود', specialty: 'طبيب قلب وأوعية دموية', rating: 4.9, reviews: 128, price: 300, location: 'شارع الجمهورية، بجوار البنك الأهلي', image: 'https://picsum.photos/seed/doc1/200/200' },
  { id: 2, name: 'د. سارة كمال', specialty: 'طبيبة أطفال وحديثي الولادة', rating: 4.8, reviews: 95, price: 250, location: 'ميدان المحطة، عمارة الأطباء', image: 'https://picsum.photos/seed/doc2/200/200' },
  { id: 3, name: 'د. محمد طارق', specialty: 'طبيب أسنان وجراحة فكين', rating: 4.7, reviews: 210, price: 200, location: 'شارع البحر، أعلى صيدلية الشفاء', image: 'https://picsum.photos/seed/doc3/200/200' },
  { id: 4, name: 'د. هدى عبد الرحمن', specialty: 'طبيبة جلدية وتجميل', rating: 4.9, reviews: 340, price: 400, location: 'برج الأطباء، الدور الثالث', image: 'https://picsum.photos/seed/doc4/200/200' },
];
        ...
        <div className="space-y-4">
          {DOCTORS.map(doc => (
            <motion.div 
              key={doc.id}
              whileTap={{ scale: 0.98 }}
              className="bg-[var(--card)] p-4 rounded-3xl border border-[var(--border)] flex flex-col gap-4 soft-shadow"
            >
